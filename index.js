            ...
            <div class="container" id="invoice">
                ...
                <div class="summary">
                   ...
                   <div class="totals">
                        ...
                        ${invoiceData?.paymentDetails?.discountAmount ? `<p><span>Discount Amount:</span> <span>₹${invoiceData?.paymentDetails?.discountAmount}</span></p>` : ''}
                        <p><span>Tax Amount:</span> <span>₹${invoiceData?.paymentDetails?.taxAmount}</span></p>
                        ${invoiceData?.paymentDetails?.fee ? `<p><span>Fee:</span> <span>₹${invoiceData?.paymentDetails?.fee}</span></p>` : ''}
                    </div>
                </div>
                <div class="footer">
                    <div class="total">
